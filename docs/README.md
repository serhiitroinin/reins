...
- [Rust sidecar example](getting-started/rust.md) uses the generated Rust types.
...
- [Live provider tests](getting-started/live-tests.md) verifies a real local
  provider account before release.

## Contracts

- [API stability](API_STABILITY.md) defines the supported TypeScript surface.
- [Architecture](ARCHITECTURE.md) defines package and host ownership.
